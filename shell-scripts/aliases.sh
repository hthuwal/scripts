...
alias youtube-dl-aria="yt-dlp --external-downloader 'aria2c' --external-downloader-args '--file-allocation=none -c -x 16 -s 16'" 
alias youtube="yt-dlp -c -f 'bestvideo[ext=mp4]+bestaudio[ext=m4a]/bestvideo+bestaudio' --merge-output-format mkv"
alias youmusic="yt-dlp -c -f 'bestaudio[ext=m4a]' -x --audio-format mp3"
